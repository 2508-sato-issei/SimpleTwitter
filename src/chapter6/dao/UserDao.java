...
public class UserDao {
	...
	public User select(Connection connection, String accounOrEmail, String password) {
		...
		try {
			...
			ps.setString(1, accounOrEmail);
			ps.setString(2, accounOrEmail);
	...
	public void update(Connection connection, User user) {
		...
		try {
			...
			if(count == 0) {
				log.log(Level.SEVERE,"更新対象のレコードが存在しません",
						new NoRowsUpdatedRuntimeException());
